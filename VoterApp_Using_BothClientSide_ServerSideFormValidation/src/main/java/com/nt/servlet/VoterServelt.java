...
public class VoterServelt extends HttpServlet {
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException{
		System.out.println("VoterServelt.dopost(-,-)");
		//get wruter
		...
		pw.println("<a href='http://localhost:4021/VoterApp_Using_BothClientSide_ServerSideFormValidation/details_form.html'><img src='Pictures/home.png' width='100' hegight='200'></a>");
